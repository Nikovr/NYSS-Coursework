...
namespace Vigenere_Cipher.UnitTests
{
    [TestClass]
    public class VigenereCipherTests
    {
        ...
        [TestMethod]
        public void Encrypt_IsCorrect_AllChars()
        {
            //Arrange
